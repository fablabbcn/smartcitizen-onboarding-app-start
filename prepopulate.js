...
function populate(jsonLang, index) {
  Object.keys(jsonLang).forEach((keyState) => {
...
fs.writeFileSync('src/assets/i18n/en.json', JSON.stringify(en, null, 2)); // 0
fs.writeFileSync('src/assets/i18n/es.json', JSON.stringify(es, null, 2));
fs.writeFileSync('src/assets/i18n/cat.json', JSON.stringify(cat, null, 2));
